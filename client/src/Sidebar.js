  ...
  return (
    <div id="sidebar-wrapper">
      ...
      <div className="list-group list-group-flush flex-grow-1">
        <button onClick={() => handleNavigation("/")} className="list-group-item list-group-item-action">Command Center</button>
        ...
        <button onClick={() => handleNavigation("/spartan")} className="list-group-item list-group-item-action">Armory</button>
